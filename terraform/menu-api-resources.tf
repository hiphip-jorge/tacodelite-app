...
# GET method for menu items by category (/menu/menu-items/items/by-category/{id})
resource "aws_api_gateway_method" "get_menu_items_by_category_id" {
  rest_api_id   = aws_api_gateway_rest_api.tacodelite_api.id
  resource_id   = aws_api_gateway_resource.menu_items_by_category_id.id
  http_method   = "GET"
  authorization = "NONE"
}

resource "aws_api_gateway_method_response" "get_menu_items_by_category_id" {
  rest_api_id = aws_api_gateway_rest_api.tacodelite_api.id
  resource_id = aws_api_gateway_resource.menu_items_by_category_id.id
  http_method = aws_api_gateway_method.get_menu_items_by_category_id.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration" "get_menu_items_by_category_id" {
  rest_api_id = aws_api_gateway_rest_api.tacodelite_api.id
  resource_id = aws_api_gateway_resource.menu_items_by_category_id.id
  http_method = aws_api_gateway_method.get_menu_items_by_category_id.http_method
...
# CORS OPTIONS for menu items by category
resource "aws_api_gateway_method" "options_menu_items_by_category_id" {
  rest_api_id   = aws_api_gateway_rest_api.tacodelite_api.id
  resource_id   = aws_api_gateway_resource.menu_items_by_category_id.id
  http_method   = "OPTIONS"
  authorization = "NONE"
...
resource "aws_api_gateway_method_response" "options_menu_items_by_category_id" {
  rest_api_id = aws_api_gateway_rest_api.tacodelite_api.id
  resource_id = aws_api_gateway_resource.menu_items_by_category_id.id
  http_method = aws_api_gateway_method.options_menu_items_by_category_id.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration" "options_menu_items_by_category_id" {
  rest_api_id = aws_api_gateway_rest_api.tacodelite_api.id
  resource_id = aws_api_gateway_resource.menu_items_by_category_id.id
  http_method = aws_api_gateway_method.options_menu_items_by_category_id.http_method
  type        = "MOCK"
...
resource "aws_api_gateway_integration_response" "options_menu_items_by_category_id" {
  rest_api_id = aws_api_gateway_rest_api.tacodelite_api.id
  resource_id = aws_api_gateway_resource.menu_items_by_category_id.id
  http_method = aws_api_gateway_method.options_menu_items_by_category_id.http_method
  status_code = aws_api_gateway_method_response.options_menu_items_by_category_id.status_code
