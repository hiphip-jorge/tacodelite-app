...
resource "aws_api_gateway_deployment" "tacodelite_api" {
  depends_on = [
    ...
    aws_api_gateway_integration.options_menu_item,
    aws_api_gateway_integration.get_menu_items_by_category_id,
    aws_api_gateway_integration.options_menu_items_by_category_id,
    ...
    aws_api_gateway_integration_response.options_menu_items_by_category_id,
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_method.options_menu_item.id,
      aws_api_gateway_method.get_menu_items_by_category_id.id,
      aws_api_gateway_method.options_menu_items_by_category_id.id,
      ...
      aws_api_gateway_integration.options_menu_item.id,
      aws_api_gateway_integration.get_menu_items_by_category_id.id,
      aws_api_gateway_integration.options_menu_items_by_category_id.id,
