...
const TABLE_NAME = process.env.DYNAMODB_TABLE || 'tacodelite-app-menu-items-staging';
...
const MODIFIERS = {
    ...
    PROTEIN_CHOICES: [
        { id: 'GROUND_BEEF', name: 'Ground Beef', price: 0, priceType: 'included', defaultSelected: true, sortOrder: 1 },
        { id: 'CHICKEN_FAJITA', name: 'Chicken Fajita', price: 0, priceType: 'included', defaultSelected: false, sortOrder: 2 },
        { id: 'STEAK_FAJITA', name: 'Steak Fajita', price: 0, priceType: 'included', defaultSelected: false, sortOrder: 3 },
        { id: 'SHREDDED_CHICKEN', name: 'Shredded Chicken', price: 0, priceType: 'included', defaultSelected: false, sortOrder: 4 },
        { id: 'EGG_SAUSAGE', name: 'Egg & Sausage', price: 0, priceType: 'included', defaultSelected: true, sortOrder: 5 },
        { id: 'EGG_CHORIZO', name: 'Egg & Chorizo', price: 0, priceType: 'included', defaultSelected: false, sortOrder: 6 }
    ],

    // Base toppings that come standard
    BASE_TOPPINGS: [
        { id: 'LETTUCE', name: 'Lettuce', price: 0, priceType: 'included', defaultSelected: true, sortOrder: 1 },
        { id: 'SHREDDED_CHEESE', name: 'Shredded Cheese', price: 0, priceType: 'included', defaultSelected: true, sortOrder: 2 },
    ...
    PREMIUM_ADDONS: [
        ...
        { id: 'QUESO', name: 'Queso', price: 1.00, priceType: 'addon', defaultSelected: false, sortOrder: 4 },
        { id: 'JALAPENOS', name: 'Jalapeños', price: 0.25, priceType: 'addon', defaultSelected: false, sortOrder: 5 }
    ],

    // Large add-ons for burritos, salads, plates
    LARGE_ADDONS: [
        { id: 'TOMATOES_LG', name: 'Tomatoes', price: 0.75, priceType: 'addon', defaultSelected: false, sortOrder: 1 },
        { id: 'SOUR_CREAM_LG', name: 'Sour Cream', price: 0.75, priceType: 'addon', defaultSelected: false, sortOrder: 2 },
        { id: 'GUACAMOLE_LG', name: 'Guacamole', price: 2.00, priceType: 'addon', defaultSelected: false, sortOrder: 3 },
        { id: 'QUESO_LG', name: 'Queso', price: 1.50, priceType: 'addon', defaultSelected: false, sortOrder: 4 },
        { id: 'BELL_PEPPERS_ONIONS', name: 'Bell Peppers & Onions', price: 1.00, priceType: 'addon', defaultSelected: false, sortOrder: 5 },
        { id: 'PICO_DE_GALLO', name: 'Pico de Gallo', price: 0.50, priceType: 'addon', defaultSelected: false, sortOrder: 6 }
    ],

    // Breakfast-specific add-ons
    BREAKFAST_ADDONS: [
        { id: 'FRESH_POTATOES', name: 'Fresh Cut Potatoes', price: 0.50, priceType: 'addon', defaultSelected: false, sortOrder: 1 },
        { id: 'BACON', name: 'Bacon', price: 0.50, priceType: 'addon', defaultSelected: false, sortOrder: 2 },
        { id: 'POTATOES_BACON', name: 'Both Potatoes & Bacon', price: 0.99, priceType: 'addon', defaultSelected: false, sortOrder: 3 }
    ],

    // Sauce and topping options
    SAUCE_OPTIONS: [
        { id: 'CHILI_CON_CARNE', name: 'Chili con Carne', price: 0, priceType: 'included', defaultSelected: false, sortOrder: 1 },
        { id: 'SOUR_CREAM_SAUCE', name: 'Sour Cream Sauce', price: 0, priceType: 'included', defaultSelected: false, sortOrder: 2 },
        { id: 'BURRITO_SAUCE', name: 'Special Burrito Sauce', price: 0, priceType: 'included', defaultSelected: true, sortOrder: 3 }
    ],

    // Removal options
    REMOVAL_OPTIONS: [
        { id: 'NO_LETTUCE', name: 'No Lettuce', price: 0, priceType: 'removal', defaultSelected: false, sortOrder: 1 },
        { id: 'NO_CHEESE', name: 'No Cheese', price: 0, priceType: 'removal', defaultSelected: false, sortOrder: 2 },
        { id: 'NO_TOMATOES', name: 'No Tomatoes', price: 0, priceType: 'removal', defaultSelected: false, sortOrder: 3 },
        { id: 'NO_SOUR_CREAM', name: 'No Sour Cream', price: 0, priceType: 'removal', defaultSelected: false, sortOrder: 4 },
        { id: 'NO_BEANS', name: 'No Beans', price: 0, priceType: 'removal', defaultSelected: false, sortOrder: 5 },
        { id: 'NO_JALAPENOS', name: 'No Jalapeños', price: 0, priceType: 'removal', defaultSelected: false, sortOrder: 6 }
    ]
};
...
const MENU_ITEM_MODIFIERS = {
    // Breakfast items
    1: { // breakfast taco
        modifierGroups: ['PROTEIN_CHOICES', 'BASE_TOPPINGS', 'BREAKFAST_ADDONS'],
        defaultSelections: {
    ...
    18: { // super burrito
        modifierGroups: ['PROTEIN_CHOICES', 'BASE_TOPPINGS', 'LARGE_ADDONS', 'SAUCE_OPTIONS'],
        defaultSelections: {
            'PROTEIN_CHOICES': ['GROUND_BEEF'],
            'BASE_TOPPINGS': ['HOMEMADE_BEANS', 'SHREDDED_CHEESE'],
    ...
    for (const [groupId, groupModifiers] of Object.entries(MODIFIERS)) {
        for (const modifier of groupModifiers) {
            modifiers.push({
                ...
                name: modifier.name,
                groupId: groupId,
                groupName: MODIFIER_GROUPS.find(g => g.id === groupId)?.name || groupId,
...
async function main() {
    try {
        ...
        console.log(`Total Modifiers: ${Object.values(MODIFIERS).flat().length}`);
        console.log(`Menu Items Updated: ${Object.keys(MENU_ITEM_MODIFIERS).length}`);

        console.log('\n=== MODIFIER GROUPS CREATED ===');
        MODIFIER_GROUPS.forEach(group => {
            console.log(`- ${group.id}: ${group.name} (${MODIFIERS[group.id]?.length || 0} modifiers)`);
        });
