            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                        We'd love to hear from you! Visit us, call us, or order online.
                    </p>
                </motion.div>
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start">
                                <span className="text-taco-green-400 mr-3 mt-1">📍</span>
                                <div>
                                    <h3 className="font-semibold text-white">Address</h3>
                                    <p className="text-gray-300">2957 W 15th St<br />Plano, TX 75075</p>
                                </div>
                            </div>
                            <div className="flex items-start">
                                <span className="text-taco-green-400 mr-3 mt-1">🚗</span>
                                <div>
                                    ...
                                    <p className="text-gray-300">Free parking available in our lot</p>
                                </div>
                            </div>
                            <div className="flex items-start">
                                <span className="text-taco-green-400 mr-3 mt-1">♿</span>
                                <div>
                                    ...
                                    <p className="text-gray-300">Wheelchair accessible entrance and seating</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
