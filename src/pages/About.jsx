    ...
    return (
        <div className='min-h-screen bg-gray-100 dark:bg-gray-900 py-8'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                ...
                >
                    <h1 className='text-4xl md:text-5xl font-hobo text-gray-900 dark:text-white mb-6'>
                        About Taco Delite
                    </h1>
                    ...
                    <div className='grid md:grid-cols-3 gap-8'>
                        {highlights.map((highlight, index) => (
                            ...
                            >
                                ...
                                <h3 className='text-xl font-secular text-gray-900 dark:text-white mb-3'>
                                    {highlight.title}
                                </h3>
                ...
                <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 md:p-12 border border-gray-200 dark:border-gray-700'>
                    ...
                    >
                        <h2 className='text-3xl font-secular text-gray-900 dark:text-white mb-4'>
                            Our Values
                        </h2>
                        <p className='text-lg text-gray-600 dark:text-gray-300'>
