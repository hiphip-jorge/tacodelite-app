...
const MenuItem = ({ item, index }) => {
    ...
    return (
        <motion.div
            ...
            className="bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-700 hover:border-taco-yellow-500/50 group"
        >
            {/* Initials Section */}
            <div className="h-48 overflow-hidden relative">
                <div className="w-full h-full bg-gradient-to-br from-taco-yellow-500 to-orange-500 flex items-center justify-center">
                    <div className="text-6xl font-bold text-white drop-shadow-lg font-hobo">
                ...
                <div className="absolute top-3 right-3">
                    <span className="bg-taco-yellow-500 text-gray-900 px-3 py-1 rounded-full font-bold text-lg shadow-lg">
