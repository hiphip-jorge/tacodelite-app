                        ...
                        <div className='px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700'>
                            {navItems.map(item => (
                                <Link
                                    ...
                                    className={`${
                                        location.pathname === item.path
                                            ? 'bg-taco-yellow-100 dark:bg-taco-yellow-900 text-taco-yellow-600 dark:text-taco-yellow-400'
                                            : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-taco-yellow-500'
