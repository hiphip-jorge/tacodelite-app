...
describe('AnnouncementBanner', () => {
    ...
    describe('Rendering', () => {
        it('should render announcement banner with first announcement', async () => {
            ...
            await waitFor(() => {
                ...
                expect(
                    screen.getByText('We will be closed on Christmas Day')
                ).toBeInTheDocument();
            });
        });
        ...
        it('should not render when no announcements are available', async () => {
            ...
            await waitFor(() => {
                expect(
                    screen.queryByText('Holiday Hours')
        ...
        it('should not render when all announcements are dismissed', async () => {
            ...
            localStorage.setItem(
                ...
                JSON.stringify(['ANN001', 'ANN002', 'ANN003'])
            );
    ...
    describe('Pagination and rotation', () => {
        ...
        it('should switch to selected announcement when pagination dot is clicked', async () => {
            ...
            await waitFor(() => {
                expect(
                    screen.getByText('Special Discount')
                ).toBeInTheDocument();
            });
        });
    });
    ...
    describe('Keyboard navigation', () => {
        it('should navigate to next announcement when right arrow is pressed', async () => {
            ...
            await waitFor(() => {
                expect(
                    screen.getByText('First Announcement')
                ).toBeInTheDocument();
            });
            ...
            await waitFor(() => {
                expect(
                    screen.getByText('Second Announcement')
                ).toBeInTheDocument();
            });
        });
        ...
        it('should not navigate when only one announcement is visible', async () => {
            ...
            await waitFor(() => {
                expect(
                    screen.getByText('Only Announcement')
                ).toBeInTheDocument();
            });
    ...
    describe('Touch gestures', () => {
        it('should navigate to next announcement on swipe left', async () => {
            ...
            const banner = screen.getByText('First Announcement').closest('div')
