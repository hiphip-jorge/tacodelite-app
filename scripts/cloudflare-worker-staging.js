    ...
    try {
        ...
        if (url.pathname.startsWith('/prod/')) {
            ...
            if (url.pathname.startsWith('/prod/admin/')) {
                ...
                const baseUrl = 'https://i8vgeh8do9.execute-api.us-east-1.amazonaws.com'
                ...
                console.log(`Proxying admin API call: ${url.pathname} -> ${apiUrl.toString()}`)
                ...
                const requestOrigin = request.headers.get('Origin') || 'https://staging.tacodelitewestplano.com'
                ...
                try {
                    ...
                    return new Response(`Admin API Gateway Error: ${error.message}`, {
                        status: 500,
        ...
        if (response.status === 404 && !url.pathname.includes('.')) {
            ...
            let fallbackPath = isAdminRequest ? '/admin/index.html' : '/index.html'
