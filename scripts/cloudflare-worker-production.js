    ...
    try {
        ...
        if (url.pathname.startsWith('/prod/')) {
            ...
            if (url.pathname.startsWith('/prod/admin/')) {
                ...
                const baseUrl =
                    'https://vkuzmcj5bl.execute-api.us-east-1.amazonaws.com';
        ...
        const s3Endpoint =
            'http://tacodelite-app-production.s3-website-us-east-1.amazonaws.com';

        // Clone headers and set correct Host
        const headers = new Headers(request.headers);
        headers.set(
            'Host',
            'tacodelite-app-production.s3-website-us-east-1.amazonaws.com'
        );
